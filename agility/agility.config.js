...
const agilityConfig = {
  ...
  languageCode: process.env.AGILITY_LANGUAGE_CODE || "en-us", //the language for your website in Agility CMS
  channelName: process.env.AGILITY_CHANNEL_NAME || "website", //the name of your channel in Agility CMS
